...
class PagIbigReport(models.TransientModel):
    ...
    def print_philhealth_report(self):
        ...
        for emp_types in emp_type:
            ...
            is_details.write('B2', f"{emp_types.name} PhilHealth Summary Report", headerformatbold)     
            ...
            if emp_types.name == "Trainee":
                ...
                SELECT  
                    ...
                    COALESCE(he.philhealth_no, '') AS philhealth_no      						   -- 8
            ...
            if emp_types.name == "Trainee":
                ...
                for department_name, employees in departments.items():
                    ...
                    is_details.write(row, 5, round(total_philhealth, 2), subtotalboldcurrency)  # Total SSS in column F
                    is_details.write(row, 6, round(total_philhealth_er, 2), subtotalboldcurrency)  # Total SSS WISP in column G
        ...
        filename = 'philhealth_summary_report.xlsx'

        return {
            "type": "ir.actions.act_url",
            "url": f"/web/content/philhealth.report/{self.id}/excel_file/{filename}?download=true",
            "target": "self",
        }