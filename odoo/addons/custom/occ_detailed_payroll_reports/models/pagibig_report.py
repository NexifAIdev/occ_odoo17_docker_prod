            ...
            if emp_types.name == "Trainee":
                ...
                for department_name, employees in departments.items():
                    ...
                    for detail_body in employees:
                        ...
                        total_pagibig_er += detail_body[7]  # Add to department-specific subtotal
                        col += 1
                ...
                total_pagibig_er_all = sum(detail[7] for detail in detail_body_row)  # Sum of all SSS WISP
                ...
                for detail_body in detail_body_row:
                    ...
                    is_details.write(row, col, detail_body[2].upper(), bodydetailnormalleft)  # Department
                    col += 1
                    is_details.write(row, col, detail_body[8].upper(), bodydetailnormalleft)  # SSS No
                    col += 1
                    is_details.write(row, col, detail_body[3], bodydetailbold)  # Hire Date
                    col += 1
                    is_details.write(row, col, detail_body[6], bodydetailnormalnetcurrency)  # HDMF
