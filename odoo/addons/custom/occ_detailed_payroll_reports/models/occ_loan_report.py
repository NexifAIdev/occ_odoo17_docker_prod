...
class OccLoanReport(models.TransientModel):
    _name = 'occ.loan.report'
    _inherit = ['paycut.mixin']
    _description = 'Occ Detailed Loan Report'
    ...
    def print_occ_detailed_loan_report(self):
        ...
        for emp_types in emp_type:
            ...
            if emp_types.name == "Trainee":
                is_details.set_column(6, 6, None, None, {'hidden': True})
                is_details.set_column(7, 7, None, None, {'hidden': True})
                is_details.set_column(8, 8, None, None, {'hidden': True})
                is_details.set_column(9, 9, None, None, {'hidden': True})
                is_details.set_column(10, 10, None, None, {'hidden': True})
                
            elif emp_types.name == "Consultant":
                is_details.set_column(5, 5, None, None, {'hidden': True})
                is_details.set_column(6, 6, None, None, {'hidden': True})
                is_details.set_column(7, 7, None, None, {'hidden': True})
                is_details.set_column(8, 8, None, None, {'hidden': True})
                is_details.set_column(9, 9, None, None, {'hidden': True})
            ...
            if emp_types.name == "Trainee":
                ...
                is_details.write(row, 6, round(total_overtime, 2), bodydetailboldnetcurrency)  # Grand total overtimeZ
        ...
        filename = 'occ_detailed_loan_report.xlsx'

        return {
            "type": "ir.actions.act_url",
            "url": f"/web/content/occ.loan.report/{self.id}/excel_file/{filename}?download=true",
            "target": "self",
        }
...
class InheritHrPayslip(models.Model):
    ...
    def action_print_detailed_loan(self):
